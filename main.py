...
#Print header
print >> filehandler,  "Participant number + Video Name,Sex,Age,Event,Target,Speed,Time Stamp, Near point radius, Near point angle, Far point radius, Far point angle, Time Stamp, Near point radius, Near point angle, Far point radius, Far point angle"
#Print Data
for item in processedlist:
